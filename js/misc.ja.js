/* jdf-1.0.0/ ja.js Date:2016-01-14 16:20:02 */ ! function(window, document, screen, navigator) {
    ...
    var jsonp = function(a) {
        ...
        var c = { create: function(a) {
                var c = function() {};
                return b(c, a), c.create = function(a) {
                    var d = new c;
                    return b(d, a), d.init && d.init(), d }, c } };
        var d = c.create({ prototype: { on_complete: function() { a[this.id] && (a[this.id] = null) }, on_failed: function() { this.failed && (this.failed(), this.failed = null) }, on_timeout: function() { this.js.onload(void 0, !0) }, init: function() {
                    var c, a = this,
                        b = this.js;
        ...
        var f = function() { e.apply(null, arguments) };
    ...
    jaService.lg = function(a, b, c) {
        ...
        var b = 0; "undefined" != typeof jdpts && jdpts._st && (b = 1e3 * jaCommonData.currentTime - jdpts._st);
        var c = {};
    ...
    document.onclick = function(a) { a = a || event;
        ...
        if (d) {
            ...
            if ("keycount" === g) { e = h + "|" + i;
                ...
                jaService.logClstag(e, j), j && /^(http:\/\/|https:\/\/|\/\/).*/.exec(j) && "_blank" !== c.getAttribute("target") && !isMeta(a) && (a.preventDefault ? a.preventDefault() : a.returnValue = !1, setTimeout(function() { window.location.href = j }, 200)) } }
