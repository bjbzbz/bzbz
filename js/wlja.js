...
! function(window, document, screen, navigator) {
    ...
    window.console || (window.console = {}, window.console.log = showDebugMsg, window.console.debug = showDebugMsg, window.console.info = showDebugMsg, window.console.warn = showDebugMsg, window.console.error = showDebugMsg), "undefined" == typeof jap && (jap = { siteId: "JA2015_111145", heatmapEnable: 0, jumpAppEnable: 0, account: "", skuid: "", shopid: "", orderid: "", adsCookieName: "", openJA: 1, extParams: {}, topic: "", anchorpvflag: 0, autoLogPv: 1 });
    ...
    function Store() {
        if ("undefined" == typeof Store._initialized) {
            var a = document.domain.replace(/.*?(\w+\.\w+)$/, "$1"),
                ...
                d = function(a, b) { window.localStorage.removeItem(a), window.localStorage.setItem(a, b) },
                e = function(a) {
                    return window.localStorage.getItem(a) };
            Store.prototype.setItem = function(a, b, d) { c(a, b, d) }, Store.prototype.getItem = function(a) {
                return b(a) }, Store._initialized = !0 } }
    var store = new Store; "object" != typeof JSON && (JSON = {}),
        function() {
            function f(a) {
                return 10 > a ? "0" + a : a } "function" != typeof Date.prototype.toJSON && (Date.prototype.toJSON = function() {
                return isFinite(this.valueOf()) ? this.getUTCFullYear() + "-" + f(this.getUTCMonth() + 1) + "-" + f(this.getUTCDate()) + "T" + f(this.getUTCHours()) + ":" + f(this.getUTCMinutes()) + ":" + f(this.getUTCSeconds()) + "Z" : null }, String.prototype.toJSON = Number.prototype.toJSON = Boolean.prototype.toJSON = function() {
                return this.valueOf() });
            ...
            function str(a, b) {
                ...
                return str("", { "": a }) }), "function" != typeof JSON.parse && (cx = /[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g, JSON.parse = function(text) {
    ...
    var ja_code_version = "1.1",
        clstag_service_type_id = "cl",
        clstag_service_version = 1,
        heatmap_service_type_id = "hm",
        heatmap_service_version = 1,
        pv_service_type_id = "pv",
        pv_service_version = 1,
        _JdaExpireSeconds = 15552e3,
        _JdbExpireSeconds = 1800,
        _JdvExpireSeconds = 1296e3,
        _JduExpireSeconds = 15552e3,
        mtSubsiteExpireSeconds = 31536e3,
        __cookie_jda = jap.__cookie_jda || "__jda",
        __cookie_jdb = jap.__cookie_jdb || "__jdb",
        __cookie_jdc = jap.__cookie_jdc || "__jdc",
        __cookie_jdu = jap.__cookie_jdu || "__jdu",
        __cookie_jdv = jap.__cookie_jdv || "__jdv",
        _log_url_ = ("https:" == document.location.protocol ? "https://mercury" : "http://mercury") + ".jcloud.com/log.gif",
        _uuid_url_ = ("https:" == document.location.protocol ? "https://mercury" : "http://mercury") + ".jcloud.com/view-uuid";
    ...
    function flashChecker() {
        ...
        if (d) {
            if (c = new ActiveXObject("ShockwaveFlash.ShockwaveFlash"), c && (a = 1, b = c.GetVariable("$version"))) {
                ...
                b = e[0] + "." + e[1] + " r" + e[2] } } else navigator.plugins && navigator.plugins.length > 0 && (c = navigator.plugins["Shockwave Flash"], c && (a = 1, b = c.description.split(" "), b && b.length >= 4 && (b = b[2] + " " + b[3])));
        return { f: a, v: b } }
    ...
    function Ic() {
        var a = Hc(),
            b = window.navigator,
            c = b.appName + b.version + a.language + b.platform + b.userAgent + a.javaEnabled + a.D + a.C + (document.cookie ? document.cookie : "") + (document.referrer ? document.referrer : ""),
            d = c.length,
            ...
            var b = function(a, b) {
                ...
                c = { create: function(a) {
                        ...
                        return b(c, a), c.create = function(a) {
                            var d = new c;
                            return b(d, a), d.init && d.init(), d }, c } },
                d = c.create({ prototype: { on_complete: function() { a[this.id] && (a[this.id] = null) }, on_failed: function() { this.failed && (this.failed(), this.failed = null) }, on_timeout: function() { this.js.onload(void 0, !0) }, init: function() {
                            var a = this,
                                b = this.js,
                                c;
                            b.onload = b.onreadystatechange = function(d, e) {
                                (e || !b.readyState || /loaded|complete/.test(b.readyState)) && (b.onload = b.onreadystatechange = null, b = null, e ? a.on_failed() : (c && clearTimeout(c), a.on_complete())) }, a.failed && (c = setTimeout(function() { a.on_timeout() }, a.timeout)) } } }),
                e = function(b, c, e, g, h) {
                    ...
                    var m = new Date,
                        n = d.create({ id: k, url: finalUrl, charset: h, failed: e, success: c, js: j, stat_time: m, timeout: g });
                    return a[k] = c, j.charset = h, j.src = finalUrl, i.appendChild(j), k },
                f = function() { e.apply(null, arguments) };
            return b(f, { guid: 0, requests: {}, avail_tag: [], request_timeout: 5 }), f }(window),
        siteId = jap.siteId || "JA2015_111145",
    ...
    var umz = [],
        isNewSession = jdb.length < 4,
        utsr = getParameter(currentUrl, "utm_source");
    if (utsr) {
        ...
        umz.push(utsr || utm_source), umz.push(camp || utm_campaign), umz.push(medi || utm_medium), umz.push(term || utm_term), utm_term = umz[3] } else {
        var search = "baidu:wd,baidu:word,so.com:q,so.360.cn:q,360so.com:q,360sou.com:q,baidu:q1,m.baidu:word,m.baidu:w,wap.soso:key,m.so:q,page.yicha:key,sz.roboo:q,i.easou:q,wap.sogou:keyword,google:q,soso:w,sogou:query,youdao:q,ucweb:keyword,ucweb:word,114so:kw,yahoo:p,yahoo:q,live:q,msn:q,bing:q,aol:query,aol:q,daum:q,eniro:search_word,naver:query,pchome:q,images.google:q,lycos:query,ask:q,netscape:query,cnn:query,about:terms,mamma:q,voila:rdata,virgilio:qs,alice:qs,yandex:text,najdi:q,seznam:q,search:q,wp:szukaj,onet:qt,szukacz:q,yam:k,kvasir:q,ozu:q,terra:query,rambler:query".split(","),
            sign = !0,
            rdomain = refererUrl && refererUrl.split("/")[2];
    ...
    preSession && preSeqnum ? (store.setItem("pre_session", preSession), store.setItem("pre_seq", preSeqnum)) : (preSession = store.getItem("pre_session") || "", preSeqnum = store.getItem("pre_seq") || ""), hashDomain || (hashDomain = getHashDomain()), store.setItem(__cookie_jda, [hashDomain, uuid, firstSessionCreateTime || "-", prevVisitCreateTime || "-", currentTime, visitTimes || 1].join("."), _JdaExpireSeconds), store.setItem(__cookie_jdb, [hashDomain, sequenceNum || 1, uuid + "|" + (visitTimes || 1), currentTime].join("."), _JdbExpireSeconds), store.setItem(__cookie_jdv, [hashDomain, utm_source || "direct", utm_campaign || "-", utm_medium || "none", utm_term || "-"].join("|"), _JdvExpireSeconds), store.setItem(__cookie_jdc, hashDomain), all_uuid ? store.setItem(__cookie_jdu, all_uuid, _JduExpireSeconds) : jsonp(_uuid_url_ + "?callback=?", function(a) { a && a.auuid && store.setItem(__cookie_jdu, a.auuid, _JduExpireSeconds) }, function() {}, 500, "utf-8");
    var fls = flashChecker();
    fls.f && (flash_ver = fls.v);
    var jaCommonData = { siteId: siteId, account: account, pinId: pinId, domain: domain, currentTime: currentTime, pageTitle: pageTitle, refererUrl: refererUrl, currentUrl: currentUrl, browserName: browserName, browserVersion: browserVersion, os: os, screenResolution: screenResolution, colorDeep: colorDeep, language: language, javaEnabled: javaEnabled, charset: charset, firstSessionCreateTime: firstSessionCreateTime, prevVisitCreateTime: prevVisitCreateTime, visitTimes: visitTimes, sessionId: uuid + "|" + visitTimes, sequenceNum: sequenceNum, jda: jda, jdb: jdb, jdv: jdv, skuid: jap.skuid || getSkuid(), orderid: jap.orderid || getOrderid(), shopid: jap.shopid || getShopid(), utm_source: utm_source, utm_campaign: utm_campaign, utm_medium: utm_medium, utm_term: utm_term, flash_ver: flash_ver, preSession: preSession, preSeqnum: preSeqnum, uuid: uuid, all_uuid: all_uuid, adsCookieName: adsCookieName, ads: ads, pre_app: pre_app, extParams: extParams, topic: topic };

    function log(a, b, c) {
        var d = "ot";
        ("pv" === a || "cl" === a) && (d = a);
        var e = JSON.stringify(c),
            f = _log_url_ + "?ut=s&d=web&lgt=" + encodeURIComponent(a) + "&lgv=" + encodeURIComponent(b) + "&sfj=" + encodeURIComponent(e) + "&uid=" + encodeURIComponent(jaCommonData.uuid) + "&pid=" + encodeURIComponent(jaCommonData.pinId) + "&cul=" + encodeURIComponent(jaCommonData.currentUrl) + "&ref=" + encodeURIComponent(jaCommonData.refererUrl) + "&pin=" + encodeURIComponent(jaCommonData.account) + "&ws=" + encodeURIComponent(jaCommonData.siteId) + "&vt=" + encodeURIComponent(jaCommonData.visitTimes) + "&sn=" + encodeURIComponent(jaCommonData.sequenceNum) + "&cut=" + encodeURIComponent(Math.round((new Date).getTime() / 1e3)) + "&tpc=" + encodeURIComponent(jaCommonData.topic + "." + d),
            g = new Image(1, 1);
        g.src = f, g.onload = function() { g.onload = null, g.onerror = null }, g.onerror = function() { g.onload = null, g.onerror = null } }
    var jaService = {};
    ...
    document.onclick = function(a) { a = a || event;
        ...
        if (d) {
            ...
            if ("keycount" === g) { e = h + "|" + i;
                ...
                jaService.logClstag(e, j), j && /http:\/\/.*?/.exec(j) && "_blank" !== c.getAttribute("target") && !isMeta(a) && (a.preventDefault ? a.preventDefault() : a.returnValue = !1, setTimeout(function() { window.location.href = j }, 200)) } }
        ...
        if (jap.heatmapEnable && /(sale|mall|jmall|pop|bdp).(jd|360buy).com/.test(k)) {
            ...
            var n = window.screen.width >= 1210 ? 1210 : 990,
                o = document.body.clientWidth > n ? Math.round((document.body.clientWidth - n) / 2) : 0;
            jaService.logHeatmap(e, l, m, o) } };

    function getUnionSeriesJsonObj() {
        var a = { psn: jaCommonData.sessionId, psq: jaCommonData.sequenceNum, ref: jaCommonData.currentUrl, usc: jaCommonData.utm_source, usp: jaCommonData.utm_campaign, umd: jaCommonData.utm_medium, utr: jaCommonData.utm_term, adk: jaCommonData.adsCookieName, ads: store.getItem(jaCommonData.adsCookieName), ext: jaCommonData.extParams };
        return a }

    function getUnionSeries() {
        var a = { psn: jaCommonData.sessionId, psq: jaCommonData.sequenceNum, ref: jaCommonData.currentUrl, usc: jaCommonData.utm_source, usp: jaCommonData.utm_campaign, umd: jaCommonData.utm_medium, utr: jaCommonData.utm_term, adk: jaCommonData.adsCookieName, ads: store.getItem(jaCommonData.adsCookieName) },
            b = JSON.stringify(a);
        return b }

    function getAndroidUnionSeries() {
        var a = getUnionSeries();
        try { window.AndriodPing.setSeriesUnion(a) } catch (b) {} }
    ...
    if (isJdChannel() && isNotProcessByUnionSystem() && 1 === jaCommonData.sequenceNum) {
        ...
        if (mtParts && 3 === mtParts.length) mtParts[channelLevel - 1] = encodeURIComponent(channelId + "," + currentTime);
            ...
            for (var j = 0; 3 > j; j++) j === channelLevel - 1 ? mtParts[j] = encodeURIComponent(channelId + "," + currentTime) : mtParts[j] = "" }
        mt = join(mtParts, "|"), store.setItem(jaCommonData.adsCookieName, mt, mtSubsiteExpireSeconds) }
    jaCommonData.ads && store.setItem(jaCommonData.adsCookieName, jaCommonData.ads, mtSubsiteExpireSeconds), String.prototype.startWith = _org_start_with_, _org_start_with_ = null, ("undefined" == typeof jap.autoLogPv || jap.autoLogPv) && (jaService.logPv(), jap.anchorpvflag && window.addEventListener("hashchange", function() { jaCommonData.refererUrl = jaCommonData.currentUrl, jaCommonData.currentUrl = document.location.href, jaCommonData.account = "undefined" != typeof jap.account ? jap.account : store.getItem("pin"), jaService.logPv() })) }(window, document, window.screen, window.navigator);